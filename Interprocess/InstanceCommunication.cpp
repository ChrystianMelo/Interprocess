...
ReadFileRequest::ReadFileRequest(const std::string& message)
{
...
const std::array<char, MESSAGE_SIZE>& ReadFileRequest::getMessage() const { return m_message; }

bool ReadFileRequest::operator==(const ReadFileRequest& other) const { return m_message == other.m_message; }
...
ReadFileRequest InstanceCommunication::getRequest() { return m_request; }
        ...
        try {
            ...
            // Lê a mensagem
            {
                ...
                // Trava uma vez para fazer a comunicação.
                {
                    ...
                    std::string msg(m_data->m_message.data());
                    m_request = ReadFileRequest(msg);

                    std::cout << "Message received from secundary instance:" <<  msg << std::endl;
                }
            }
            ...
            // Responde a mensagem
            {
                ...
                std::cout << "Sending result to secundary instance:"<< isAvailable << std::endl;
...
bool InstanceCommunication::runAsClient(ReadFileRequest request)
{
    try {
        boost::interprocess::shared_memory_object object(
        ...
        // Escreve uma mensagem
        {
            ...
            {
                m_data->m_message = request.getMessage();

                std::cout << "Sending request to primary instance:"<< request.getMessage().data() << std::endl;
        ...
        // Lê a resposta.
        {
            ...
            std::cout << "Request response received from main instance:"<< response << std::endl;
